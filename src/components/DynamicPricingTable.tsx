...
const initialPricingData: PricingItem[] = [
  { system: 'Initial Consultation and Needs Assessment', category: 'Set-Up & Configuration', costPerUnit: 5000, units: 1, rateType: 'Once-off' },
  { system: 'Customized Solution Design', category: 'Set-Up & Configuration', costPerUnit: 10000, units: 1, rateType: 'Once-off' },
  { system: 'Project Establishment & Setup', category: 'Set-Up & Configuration', costPerUnit: 7500, units: 1, rateType: 'Once-off' },
  { system: 'System Setup and Configurations', category: 'Set-Up & Configuration', costPerUnit: 15000, units: 1, rateType: 'Once-off' },
  { system: 'Users Setup', category: 'Set-Up & Configuration', costPerUnit: 500, units: 10, rateType: 'Once-off' },
  { system: 'Control Systems Implementation', category: 'Set-Up & Configuration', costPerUnit: 10000, units: 1, rateType: 'Once-off' },
  { system: 'Staff Training and Onboarding', category: 'Set-Up & Configuration', costPerUnit: 2000, units: 10, rateType: 'Once-off' },
  { system: 'Go-Live and Initial Monitoring', category: 'Set-Up & Configuration', costPerUnit: 5000, units: 1, rateType: 'Once-off' },
  { system: 'Performance Review and Optimization', category: 'Set-Up & Configuration', costPerUnit: 3000, units: 1, rateType: 'Once-off' },
  { system: 'Access Control: Driver ID Readers & Tags', category: 'Capital Expenditure', costPerUnit: 1600, units: 150, rateType: 'Once-off' },
  { system: 'CCTV Monitoring Systems', category: 'Capital Expenditure', costPerUnit: 12500, units: 10, rateType: 'Once-off' },
  { system: '24 Hour Call Centre', category: 'Monitoring', costPerUnit: 150000, units: 1, rateType: 'Monthly Fee' },
  { system: 'GPS Telematics', category: 'Monitoring', costPerUnit: 249, units: 150, rateType: 'Monthly Fee' },
  { system: 'Video Telematics', category: 'Monitoring', costPerUnit: 499, units: 150, rateType: 'Monthly Fee' },
  { system: 'Driver Behavior Monitoring', category: 'Monitoring', costPerUnit: 399, units: 150, rateType: 'Monthly Fee' },
  ...
  { system: 'Inspection Application', category: 'Monitoring', costPerUnit: 99, units: 150, rateType: 'Monthly Fee' },
  ...
  { system: 'Fleet Maintenance Solution', category: 'Repairs & Maintenance Digital Platform', costPerUnit: 462.50, units: 150, rateType: 'Monthly Fee' },
  { system: 'Installation of Access Control Systems', category: 'Installation', costPerUnit: 1000, units: 150, rateType: 'Once-off' },
  { system: 'Installation of CCTV Monitoring Systems',  category: 'Installation', costPerUnit: 10000, units: 10, rateType: 'Once-off' },

  { system: 'Access Control & CCTV Monitoring', category: 'Monitoring', costPerUnit: 200, units: 200, rateType: 'Monthly Fee' },
...
const categories = ['Capital Expenditure', 'Installation','Set-Up & Configuration', 'Monitoring', 'Management', 'Repairs & Maintenance Digital Platform', 'Other Value Added Services'];
