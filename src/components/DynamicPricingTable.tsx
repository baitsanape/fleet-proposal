...
const initialPricingData: PricingItem[] = [
  { system: 'Initial Consultation and Needs Assessment', category: 'Set-Up', costPerUnit: 5000, units: 1, rateType: 'Once-off' },
  { system: 'Customized Solution Design', category: 'Set-Up', costPerUnit: 10000, units: 1, rateType: 'Once-off' },
  { system: 'Project Establishment & Setup', category: 'Set-Up', costPerUnit: 7500, units: 1, rateType: 'Once-off' },
  { system: 'System Setup and Configurations', category: 'Set-Up', costPerUnit: 15000, units: 1, rateType: 'Once-off' },
  { system: 'User Setups', category: 'Set-Up', costPerUnit: 500, units: 10, rateType: 'Once-off' },
  { system: 'Control Systems Implementation', category: 'Set-Up', costPerUnit: 10000, units: 1, rateType: 'Once-off' },
  { system: 'Staff Training and Onboarding', category: 'Set-Up', costPerUnit: 2000, units: 10, rateType: 'Once-off' },
  { system: 'Go-Live and Initial Monitoring', category: 'Set-Up', costPerUnit: 5000, units: 1, rateType: 'Once-off' },
  { system: 'Performance Review and Optimization', category: 'Set-Up', costPerUnit: 3000, units: 1, rateType: 'Once-off' },
  { system: 'Ongoing Support Setup', category: 'Set-Up', costPerUnit: 2000, units: 1, rateType: 'Once-off' },
  { system: 'GPS Telematics (Teltonika FMB920 GNSS/GSM Terminal)', category: 'Monitoring', costPerUnit: 277.50, units: 150, rateType: 'Monthly Fee' },
  { system: 'Video Telematics (Streamax AD Plus)', category: 'Monitoring', costPerUnit: 647.50, units: 150, rateType: 'Monthly Fee' },
  ...
  { system: 'Fuel Management (with Fuel Level Sensor)', category: 'Management', costPerUnit: 222, units: 150, rateType: 'Monthly Fee' },
  ...
  { system: 'Inspection Application (Per Vehicle)', category: 'Repairs & Maintenance Digital Platform', costPerUnit: 99, units: 150, rateType: 'Monthly Fee' },
  ...
  { system: 'Access Control & CCTV Monitoring', category: 'Maintenance', costPerUnit: 2000, units: 1, rateType: 'Monthly Fee' },
  { system: 'Tyre Management (with Tyre Pressure Sensor)', category: 'Maintenance', costPerUnit: 370, units: 150, rateType: 'Monthly Fee' },
...
const categories = ['Set-Up', 'Monitoring', 'Management', 'Repairs & Maintenance Digital Platform', 'Maintenance', 'Other Value Added Services'];
