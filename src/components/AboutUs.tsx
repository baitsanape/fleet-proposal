  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div>
        ...
        <p className="mb-4">
          Baitsanape IT Company (Pty) Ltd is a leading provider of innovative IT solutions, specializing in fleet management and technology integration. We are the creators and owners of RainRock Fleet Management Technology, a registered trademark of our company.
        </p>
        <p className="mb-4">
